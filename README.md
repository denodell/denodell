...
I’ve worked with global brands like **Canva**, **Volvo Cars**, **Nike**, **UNICEF**, **AKQA**, and **MINI**, and authored two JavaScript books used in universities and cited in academic research. Today, I’m building tools that help developers ship better frontends out of the box.
...
- [🧑‍💻 HTML's Best Kept Secret: The `<output>` Tag](https://denodell.com/blog/html-best-kept-secret-output-tag?utm_source=github&utm_medium=profile&utm_campaign=personal_readme) - 100,000 reads so far!
